...
siguientes preguntas considerando la Tabla \ref{tab:org33a771e} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:org33a771e}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
...
Anthony Erazo &  & colaborador\\[0pt]
Dylan Zuñiga &  & colaborador\\[0pt]
\hline
\end{tabular}
\end{center}

\section{Verificación de Entregables [0\%]}
\label{sec:org22ea38d}
