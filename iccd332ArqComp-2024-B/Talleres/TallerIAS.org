...
2. ¿Se sobrescribe algún registro como resultado de la ejecución? Si
   ...
   Respuesta:
   - $[940] \leftarrow 0x0000000003$
   - $[941] \leftarrow 0x0000000006$
   - $[AC] \leftarrow 0xFFFFFFFFFD$
...
3. ¿Cuál es el valor del bit de Carry? ¿Qué operación modifica el bit?
   ...
   - $[AC] \leftarrow [AC]-[941]$
     $[AC] \leftarrow 0x0000000005-0x0000000002$
...
| Nombre        | Email                    | Rol         |
|---------------+------------------------- +-------------|
| Joset Muela   | joset.muela@epn.edu.ec   | lider       |
| Anthony Erazo | anthony.erazo@epn.edu.ec | colaborador |
